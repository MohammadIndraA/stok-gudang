@extends('layouts.app', ['title' => 'Aplikator'])
@section('content')
    <div
            ...
            <div class="w-full relative mb-4">
                <div class="flex-auto p-0 md:p-4">
                    ...
                    <div class="flex flex-wrap gap-4 mb-3">
                        <div>
                            <a href="{{ route('admin.aplikator.create') }}"
                    ...
                    <div
                        ...
                        <div class="sm:-mx-6 lg:-mx-8">
                            <div class="relative overflow-x-auto block w-full sm:px-6 lg:px-8">
                                <table class="w-full" id="aplikatorTable">
...
@section('scripts')
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#aplikatorTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.aplikator.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
                        orderable: false
