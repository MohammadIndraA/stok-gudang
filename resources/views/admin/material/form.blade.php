                 ...
                 <div
                     ...
                     <div class="flex-auto p-4 ">
                         <form
                             ...
                             {{-- Satuan --}}
                             <x-input-v2 name="satuan" label="Satuan" :value="old('satuan', $material->satuan ?? '')" placeholder="Satuan"
                                 required="true" type="text" />
                             {{-- Stok Minimum --}}
                             <x-input-v2 name="stok_minimum" label="Stok Minimum" :value="old('stok_minimum', $material->stok_minimum ?? '')" placeholder="200"
