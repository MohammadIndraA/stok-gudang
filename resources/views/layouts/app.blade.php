...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('design-system/assets/images/logo-sic.png') }}" />
    ...
    <div class="min-h-full z-[99]  fixed inset-y-0 print:hidden dark:bg-[#06090f] main-sidebar duration-300 bg-white">
        <div
            ...
            <a href="index.html" class="logo">
                <span>
                    <img src="{{ asset('design-system/assets/images/logo-sic.png') }}" alt="logo-small"
                        class="logo-sm h-8 align-middle inline-block">
                </span>
                <span>
                    <img src="{{ asset('design-system/assets/images/text-logo.png') }}" alt="logo-large"
