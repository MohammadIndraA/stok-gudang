    <nav id="topbar"
        class="topbar border-b  dark:border-slate-700/40  fixed inset-x-0  duration-300
             block print:hidden z-50 bg-white dark:bg-[#06090f]">
        <div
                ...
                <div class="me-2  dropdown relative">
                    ...
                    focus:bg-none focus:ring-0 dark:focus:ring-0 md:me-0"
                        ...
                        <span class="ltr:ms-2 rtl:ms-0 rtl:me-2 hidden text-left xl:block">
                            <span
                                class="block font-medium text-slate-600 dark:text-gray-300">{{ Auth::user()->username }}</span>
                            <span class="-mt-0.5 block text-xs text-slate-500 dark:text-gray-400"></span>
                        </span>
                    </button>
